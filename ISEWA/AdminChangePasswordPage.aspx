<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminChangePasswordPage.aspx.cs" Inherits="ISEWA.AdminChangePasswordPage" %>
                ...
                <table class="auto-style1">
                    <tr>
                        <td colspan="2" style="background-color: #4169e1; height: 30px;color: White;" align="center">
                            <asp:Label ID="Label6" runat="server" Text="Change Your Password" ForeColor="Black"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="auto-style4">
                            <asp:TextBox ID="txtAdminEmail" runat="server" Width="264px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" ForeColor="#CC0000"
                        ValidationGroup="Validform" ControlToValidate="txtAdminEmail" runat="server" ErrorMessage="Your Email Is Required." SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style5">
                        ...
                        ValidationGroup="Validform" ControlToValidate="txtCurrentPassword" runat="server" ErrorMessage="Your Current Password Is Required." SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style5">
                    ...
                    <tr>
                        ...
                        ValidationGroup="Validform" ControlToValidate="txtConfirmPassword" runat="server" ErrorMessage="Please Re-Enter New Password" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator2" Display="Dynamic" ForeColor="#CC0000" 
                        ValidationGroup="Validform" ControlToCompare="txtNewPassword" ControlToValidate="txtConfirmPassword" runat="server" ErrorMessage="The Passwords Don't Match." SetFocusOnError="True"></asp:CompareValidator>
                        </td>
                    </tr>
                    <caption>
                        &nbsp;
