...
namespace ISEWA
{
    public partial class EventCoordinatorChangePasswordPage : System.Web.UI.Page
    {
        ...
        {
            EventCoordinatorClass objChangePassword = new EventCoordinatorClass(txtEventCoordinatorEmail.Text.Trim(), txtCurrentPassword.Text.Trim(), txtNewPassword.Text.Trim());
