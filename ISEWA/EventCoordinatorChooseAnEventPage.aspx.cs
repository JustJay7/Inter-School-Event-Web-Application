...
namespace ISEWA
{
    public partial class EventCoordinatorChooseAnEventPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                SqlCommand com = new SqlCommand("SELECT DISTINCT FestName FROM EventDetails WHERE EventCoordinator = '" + Session["EventCoordinatorEmail"].ToString() + "'", con);
                // table name   
        ...
        {
            EventCoordinatorClass objInputScores = new EventCoordinatorClass(ddlFestName.SelectedValue, ddlEventName.SelectedValue);

            bool Result = objInputScores.ScoresGiven();
            ...
            else
            {
                ...
                lblErrorMessage.Text = "The event scores have already been given.";
            }
        }
